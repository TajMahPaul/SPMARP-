...
def main():
    ...
    try:
        ...
        c.execute('''CREATE TABLE IF NOT EXISTS crime_points (CAuid integer PRIMARY KEY AUTOINCREMENT, d_id integer, type text, location_string text, month integer, year integer, lon real, lat real, closest_demand integers, FEDcode integer)''')
