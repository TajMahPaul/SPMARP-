...
def main():
    ...
    crime_df = crime_df.rename(columns={"INCIDENT_TYPE": "type", "HUNDRED_BLOCK": "location_string", "demand_point": "closest_demand", "MONTH": "month", "YEAR": "year", "FILE_NUMBER": "file_number"})
